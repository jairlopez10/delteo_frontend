...
import Combobastauno409 from "../components/productsection/Combobastauno409";
...
const Producto = () => {
  ...
  const idlanzadoras = [2, 13, 50, 303, 277, 51, 290, 370, 371, 372, 373, 374, 375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 387, 388, 395, 401, 409]
        ...
        <div className="imagen-titulos">
          ...
          <div className="contenido-producto-final">
            ...
            {tipocliente === "m" ? (
              ...
              <>
                <p className="precio-prod-antes">{`$${producto.precio >= 20000 ? ((producto.precio + envio.grande)/0.7).toLocaleString('es-CO') : ((producto.precio + envio.pequeno)/0.7).toLocaleString('es-CO')}`}</p>
                <div className="flex items-center gap-3">
                  ...
                  <p className="oferta-text">30% DESCTO</p>
                </div>
