  ...
  return (
    <>
        ...
        <div className="div-aida">
          ...
          <p className=" mt-4 text-center">¡Aprovecha esta promoción que es valida <span className="font-bold">hasta el 12 Octubre 2024!</span> Ultimas unidades disponibles</p>
        </div>
        <div className="div-aida">
