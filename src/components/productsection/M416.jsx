...
const M416 = () => {
  return (
    <>
        ...
        <div className="div-aida">
          <img src="/m416e.gif" alt="gif m416" />
          <h4 className=" mt-4">¡Siempre listo para la acción!</h4>
          <p className=" mt-4 text-center">¡Juega intensamente con sus <span className="font-bold">cargadores de municiones intercambiables </span>para que NO estes con la guardia abajo!</p>
        </div>
        <div className="div-aida">
          <img src="/m416f.gif" alt="gif m416" />
          <h4 className=" mt-4">¿Buscas tener la mejor precisión?</h4>
          <p className=" mt-4 text-center">Dispara a distancias de hasta <span className='font-bold'>25 metros</span> gracias a su mira telescopica 🎯!</p>
        </div>
        <div className="div-aida">
